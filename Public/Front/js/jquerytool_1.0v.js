...
jQuery.extend({
	...
	anewAlert:function(msg,flag,mark,url){
		...
		html+='<button class="btn1" onclick="$.asureLwtFun(this);" style="margin-left:0px!important;margin-right:10px!important;padding:6px 35px;background:#5ab2e0;border-radius:3px;color:#fff;color:#fff;margin-top:15px;" type="button">确定</button>';
		if(flag==1){
			html+='<button class="btn3" onclick="$.asureLwtFunClose();" type="button" data-target=".bs-example-modal-lg" data-toggle="modal" style="margin-left:0px!important;padding:6px 35px;background:#999;border-radius:3px;color:#fff;color:#fff;margin-top:15px;">取消</button>';
		}
		html+='</div>';
